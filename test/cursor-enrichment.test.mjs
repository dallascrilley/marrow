...
const fixturesRoot = join(
  "/Users/operator/.cursor/agent-session-distillery",
  "test",
  "fixtures",
  "cursor"
);
...
test("state DB enrichment reads composer and workspace metadata from the frozen fixture", () => {
  ...
  assert.deepEqual(enrichment, {
    ...
    matchedKeys: [
      "cursor.composer.active",
      "cursor.composer.recent",
      "cursor.workspace.roots"
    ],
    workspaceIds: ["ws-001"],
    workspacePaths: [
      "/Users/example/Code/distillery",
      "/Users/example/Code/shared"
    ]
  });
});
