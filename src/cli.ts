...
const commandTree: Record<string, CommandDefinition> = {
  ingest: {
    ...
    subcommands: {
      backfill: {
        description: "Ingest historical Cursor transcripts with optional since/limit/resume controls.",
...
async function withLedger(
  context: CommandContext,
  execute: (context: CommandContext, database: Awaited<ReturnType<typeof createLedger>>) => Promise<number>
): Promise<number> {
