...
import { errorSignatureTrigger } from "./extract/error-signatures.js";
...
import {
  hasExcessiveMarkdownStructure,
  looksLikeRawKnowledgeDump,
  looksLikeRawWorkflowSummary,
} from "./extract/raw-dump-predicates.js";
