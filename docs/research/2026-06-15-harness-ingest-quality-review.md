...
| `96100643-...` | `/skill:wp-wordpress-to-astro example.org` | deterministic | 20 | Large session, but most learnings are raw narrative/error snippets rather than concise rules. |
