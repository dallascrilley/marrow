...
| Pipeline gate timing (skip-ingest) | Cron-fast gate ~0.6s vs full five-adapter scan ~35s on operator runtime (5033 pending @ 2026-06-16). | `/tmp/agent-session-distillery/2026-06-16_pipeline-gate-timing/SUMMARY.md` |
